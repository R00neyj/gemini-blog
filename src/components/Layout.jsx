...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-primary text-gray-100 font-sans flex relative overflow-hidden">
      ...
      {/* Mobile Bottom Area */}
      <div 
        className="fixed bottom-6 left-4 right-4 max-w-xl mx-auto z-50 md:hidden animate-slide-up bg-[#191919]/60 backdrop-blur-xl border border-white/10 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4)] px-2 py-2"
